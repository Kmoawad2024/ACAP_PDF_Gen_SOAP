				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block>
						...
						<fo:block  font-family="Arial" font-size="20pt">
							<fo:inline>Flat Rate Billing</fo:inline>
						</fo:block>
							...
							<fo:table-body border="inherit">
										...
										<fo:table-row border="inherit">
											...
											<fo:table-cell border="inherit"  
												...
												<fo:block  font-family="Arial"
													font-size="8pt">
													<xsl:value-of select="concat(ACAP_AddressStreet,'&#10;',ACAP_Address2)" />
												</fo:block>
											</fo:table-cell>
									...
									<xsl:for-each select="//attorneyfeeclaim//Children//Child">
										<xsl:if test="Name!=''">
											<fo:table-row>
												...
												<!--<fo:table-cell text-align="center" display-align="center" border="solid .1mm black">
													<fo:block  font-family="Arial"
												font-size="8pt">&#x00A0;<xsl:value-of select="format-number(//attorneyfeeclaim//itemizedExpense//CostForEachClient,'##.00')"/>
													</fo:block>
												</fo:table-cell>-->
											</fo:table-row>
										</xsl:if>
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedQuantity != '0.0'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedQuantity | //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedQuantity | //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedQuantity),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedTotalCost != '0.00'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedTotalCost),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost != '0.00'">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost),"##.00" )' />
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell border="solid .1mm black" 
										...
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">Signature of Attorney</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell border="solid .1mm black"  
												...
												<fo:block  font-family="Arial"
													...
													<xsl:value-of select='format-number(sum(//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//HoursAdjustment),"##.00" )' />
													</xsl:if>
												</fo:block>
											</fo:table-cell>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedQuantity != '0.0' or //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedQuantity != '0.00'">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//CSS//AuditApprovedQuantity  | //attorneyfeeclaim//itemizedExpense//CSSGT4//AuditApprovedQuantity  | //attorneyfeeclaim//itemizedExpense//CSSPAC//AuditApprovedQuantity  | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedQuantity) ,"##.00" )' />
												</xsl:if>
