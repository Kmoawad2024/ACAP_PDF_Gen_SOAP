				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						...
						<fo:block font-family="Arial" font-size="20pt">
							<fo:inline>Interpreter Claim (Standard Billing)</fo:inline>
						</fo:block>
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													...
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity != '0.00'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost != '0.00'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													...
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedQuantity != '0.00'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedQuantity),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost != '0.00'">
														<xsl:value-of
															select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost),"##.00" )' />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost != '0.00'or //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost != '0.00' ">
													<xsl:value-of
									...
									<xsl:when test="ACAP_AuditorLogin">
										<fo:table-row>
											...
											<fo:table-cell border="solid .1mm black"
												...
												<fo:block font-family="Arial" font-size="8pt">
													<xsl:if
														test="//attorneyfeeclaim//ACAP_AuditorLogin !='' and (//attorneyfeeclaim//SubmitforFinalApproval or //attorneyfeeclaim//Paid or //attorneyfeeclaim//ACAP_ProcessEscalationReason ='Escalate to Batch')">
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//Words//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedQuantity != '0.00' ">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity  | //attorneyfeeclaim//itemizedExpense//Words//AuditApprovedQuantity | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedQuantity ) ,"##.00" )' />
												</xsl:if>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost != '0.00' ">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost),"##.00" )' />
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
