			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						...
						<fo:block font-family="Arial" font-size="20pt">Expert or Witness
							Claim
						</fo:block>
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedTotalCost != '0.00'">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedTotalCost),"##.00" )' />
												</xsl:if>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost != '0.00' or //attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedTotalCost != '0.00'">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedTotalCost),"##.00" )' />
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell border="solid .1mm black"
												...
												<fo:block font-family="Arial" font-size="8pt">
													<fo:inline>
														<xsl:value-of
															select="concat('signed electronically by ',ACAP_Vendor_Name,attribution)" />
									...
									<xsl:when
										...
										<fo:table-row>
											...
											<fo:table-cell border="solid .1mm black"
												...
												<fo:block font-family="Arial" font-size="8pt">
													<xsl:if
														test="//attorneyfeeclaim//SubmitforFinalApproval or  or //attorneyfeeclaim//Paid">
														<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//HoursAdjustment),"##.00" )' />
													</xsl:if>
												</fo:block>
											</fo:table-cell>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													test="//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity != '0.00' or //attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedQuantity != '0.00'">
													<xsl:value-of
														select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedQuantity  | //attorneyfeeclaim//itemizedExpense//Expenses//AuditApprovedQuantity) ,"##.00" )' />
												</xsl:if>
