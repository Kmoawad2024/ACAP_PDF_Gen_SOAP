				...
				<fo:flow flow-name="xsl-region-body">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell padding-left="3pt" text-align="left" padding-before="2pt" padding-after="2pt"
											...
											<fo:block font-family="Arial" font-size="20pt">Attorney Fee Non Capital Claim
											</fo:block>
										</fo:table-cell>
										<xsl:choose>
					...
					<fo:block margin-top="5mm">
						...
						<!-- 	<fo:table-column column-width="14%" />
							...
							<fo:table-column column-width="20%" /> -->
							<!--  Modified for defect number 338-->
							<fo:table-column column-width="14%" />
							<fo:table-column column-width="8%" />
							<fo:table-column column-width="14%" />
							<fo:table-column column-width="8%" />
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													...
													<xsl:value-of
														select="format-number(round ( 100.0000000001 *(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Incourt'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='OutCourt'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='NecessaryExpenses'])) div 100,'##.00' )" />
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-weight="bold"
											...
											represents an accurate, complete
											statement of time and
