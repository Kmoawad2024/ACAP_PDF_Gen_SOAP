								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell padding-left="3pt" text-align="left" padding-before="2pt" padding-after="2pt"
											...
											<fo:block font-family="Arial" font-size="20pt">Dependency and Neglect Claim
											</fo:block>
										</fo:table-cell>
										<xsl:choose>
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													...
													<xsl:value-of select="format-number(//attorneyfeeclaim//itemizedExpense//HoursAdjustment,'##.000')" />	
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
										...
										font-size="8pt">
											<fo:inline>
												<xsl:if test="//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost != '0.00' ">
													<xsl:value-of select='format-number(round( 100 * sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost)) div 100,"##.00" )'/>
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
