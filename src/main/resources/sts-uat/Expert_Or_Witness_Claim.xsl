										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:if
													...
													<xsl:value-of
													select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Expenses']),'##.000' )" />																
												</xsl:if>
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													...
													<xsl:value-of
														select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Hours'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Expenses']),'##.000' )" />
												</xsl:if>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
											...
											<fo:table-cell border="solid .1mm black"
												...
												<fo:block font-family="Arial" font-size="8pt">
													<xsl:if
														...
														<xsl:value-of
														select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Hours'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Expenses'] | //attorneyfeeclaim//itemizedExpense//HoursAdjustment),'##.000' )" />
													</xsl:if>
												</fo:block>
											</fo:table-cell>
