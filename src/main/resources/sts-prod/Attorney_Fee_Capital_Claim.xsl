								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell padding-left="3pt" text-align="left" padding-before="2pt" padding-after="2pt"
											...
											<fo:block font-family="Arial" font-size="20pt">Attorney Fee Capital Claim
											</fo:block>
										</fo:table-cell>
										<xsl:choose>
							...
							<fo:table-body>
									...
									<xsl:when test="ACAP_PrimaryOffense">
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">Original
													Offense
												</fo:block>
											</fo:table-cell>
								...
								<fo:table-row>
									<fo:table-cell padding-left="3pt" border="solid .1mm black"
										text-align="left" padding-before="2pt" padding-after="2pt"
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">TCA Section
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<xsl:call-template name="replace-string">
												<xsl:with-param name="text" select="TCA_Section" />
												<xsl:with-param name="replace" select="','" />
												<xsl:with-param name="with" select="'&#x2028;'" />
											</xsl:call-template>
										</fo:block>
								...
								<xsl:choose>
									<xsl:when test="ACAP_OffenseClass">
										<fo:table-row>
											<fo:table-cell padding-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">Class
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell border="solid .1mm black"
												...
												<fo:block font-family="Arial" font-size="8pt">
													<xsl:call-template name="replace-string">
														<xsl:with-param name="text" select="ACAP_OffenseClass" />
														<xsl:with-param name="replace" select="','" />
														<xsl:with-param name="with" select="'&#x2028;'" />
													</xsl:call-template>
												</fo:block>
								...
								<fo:table-row>
									<fo:table-cell margin-left="3pt" border="solid .1mm black"
										text-align="left" padding-before="2pt" padding-after="2pt"
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">Death penalty
										</fo:block>
									</fo:table-cell>
									...
									<xsl:when test="//attorneyfeeclaim//ACAP_DateofWithdrawl">
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">If notice
													was withdrawn give date
												</fo:block>
											</fo:table-cell>
									...
									<xsl:when test="//attorneyfeeclaim//ACAP_Disposition">
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">Disposition
													of Case
												</fo:block>
											</fo:table-cell>
								...
								<!--commented for AR-408 <fo:table-row>
									<fo:table-cell margin-left="3pt" border="solid .1mm black"
										text-align="left" padding-before="2pt" padding-after="2pt"
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">Date of
									...
									<fo:table-cell border="solid .1mm black"
										...
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">
											<xsl:value-of select="//attorneyfeeclaim//ACAP_DateofLastActivity" />
								...
								<fo:table-row>
									<fo:table-cell margin-left="3pt" border="solid .1mm black"
										text-align="left" padding-before="2pt" padding-after="2pt"
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">Conviction
											Offense
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell border="solid .1mm black"
										...
										display-align="before">
										<fo:block font-family="Arial" font-size="8pt">
											<xsl:value-of select="//attorneyfeeclaim//ACAP_ConvictionOffense" />
										</fo:block>
									</fo:table-cell>
									...
									<xsl:when test="//attorneyfeeclaim//ACAP_Outcome">
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
												<fo:block font-family="Arial" font-size="8pt">Sentence
													received
												</fo:block>
											</fo:table-cell>
								...
								<xsl:choose>
									<xsl:when
										test="//attorneyfeeclaim//ACAP_First!='' or //attorneyfeeclaim//ACAP_FirmName !=''">
										<fo:table-row>
											<fo:table-cell margin-left="3pt" border="solid .1mm black"
												text-align="left" padding-before="2pt" padding-after="2pt"
												display-align="before">
											...
											<fo:inline>
												<xsl:choose>
													<xsl:when
														...
														<xsl:value-of
															select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedQuantity[@expenseType='Incourt']),'##.000' )" />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
											...
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//lineItem//Incourt = 'Incourt'">
														<xsl:value-of
															select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Incourt']),'##.000' )" />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
											...
											<fo:inline>
												<xsl:choose>
													<xsl:when
														test="//attorneyfeeclaim//itemizedExpense//lineItem//OutCourt = 'OutCourt'">
														<xsl:value-of
															select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='OutCourt']),'##.000' )" />
													</xsl:when>
													<xsl:otherwise>
														<fo:inline />
													</xsl:otherwise>
...
<xsl:if test="//attorneyfeeclaim//itemizedExpense//lineItem">
								...
								<!--End of added ans started commented for AR-613 -->
