		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:flow flow-name="xsl-region-body">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell padding-left="3pt" text-align="left" padding-before="2pt" padding-after="2pt"
											...
											<fo:block font-family="Arial" font-size="20pt">Time Log Billing
											</fo:block>
										</fo:table-cell>
										<xsl:choose>
							...
							<fo:table-body border="inherit">
								...
								<fo:table-row border="inherit">
									...
									<fo:table-cell border="inherit" margin-left="80pt"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<xsl:if												
												test=" //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='TravelTimeExpenses'] != '0.00'">
												<xsl:value-of
													select="format-number(sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='TravelTimeExpenses']),'##.000' )" />
											</xsl:if>
										</fo:block>
									</fo:table-cell>
					...
					<xsl:if
						test="//attorneyfeeclaim//itemizedExpense//lineItem//NecessaryExpenses and //attorneyfeeclaim//itemizedExpense//lineItem//ExpenseType!=''">
						<fo:block margin-top="5mm">
							<fo:table>
								...
								<fo:table-body>
									<xsl:if
										test="//attorneyfeeclaim//itemizedExpense//lineItem//NecessaryExpenses">
										<xsl:for-each
											select="//attorneyfeeclaim//itemizedExpense//lineItem">
											<xsl:if test="NecessaryExpenses ='NecessaryExpenses'">
												<fo:table-row>
							...
							<fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												<xsl:if
													test=" //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='NecessaryExpenses'] != '0.00'">
													<xsl:value-of
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
											<fo:inline>
												...
												<xsl:value-of
													select="format-number(round( 100.0000000001 * sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Words'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='Hours'] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType='NecessaryExpenses'] )) div 100,'##.00' )" />													
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
								...
								<fo:table-row>
									...
									<fo:table-cell border="solid .1mm black"
										...
										<fo:block font-family="Arial" font-size="8pt">
										<!-- Electronic Signature Epic -->	
										<!-- <xsl:value-of select='format-number(sum(//attorneyfeeclaim//itemizedExpense//Words//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//Hours//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//NecessaryExpenses//AuditApprovedTotalCost | //attorneyfeeclaim//itemizedExpense//HoursAdjustment),"##.00" )' /> -->
											<xsl:if
												test="//attorneyfeeclaim//ACAP_ClaimStatus = 'Awaiting Judge Signature' or //attorneyfeeclaim//SubmitforFinalApproval or //attorneyfeeclaim//ACAP_ClaimStatus = 'Ready To Batch' or //attorneyfeeclaim//ACAP_ClaimStatus = 'Ready to Batch' or //attorneyfeeclaim//Paid">													
													<xsl:value-of 
													select='format-number(round (100.0000000001 * sum(//attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType="Words"] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType="Hours"] | //attorneyfeeclaim//itemizedExpense//lineItem//AuditApprovedTotalCost[@expenseType="NecessaryExpenses"] | //attorneyfeeclaim//itemizedExpense//HoursAdjustment)) div 100,"##.00" )' />
											</xsl:if>
										<!-- Electronic Signature Epic -->	
										</fo:block>
									</fo:table-cell>
